...
RESPECT_MARKET_HOURS = _env_flag("TRADING_BOT_RESPECT_MARKET_HOURS", "SOXL_BOT_RESPECT_MARKET_HOURS", default=True)
...
ALLOW_AFTER_HOURS = _env_flag("TRADING_BOT_ALLOW_AFTER_HOURS", "SOXL_BOT_ALLOW_AFTER_HOURS", default=False)
...
SIGNAL_ONLY = _env_flag("TRADING_BOT_SIGNAL_ONLY", "SOXL_BOT_SIGNAL_ONLY", default=False)
...
# orders, until you explicitly set TRADING_BOT_LIVE_TRADING=true (or the
# legacy SOXL_BOT_LIVE_TRADING=true) in the environment. This is a deliberate
# safety default.
LIVE_TRADING = _env_flag("TRADING_BOT_LIVE_TRADING", "SOXL_BOT_LIVE_TRADING", default=False)
